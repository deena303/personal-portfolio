      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            ...
            <a href={socialLinks.whatsapp} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white" aria-label="WhatsApp">
          ...
          <div
            data-aos="fade-up"
            data-aos-delay="100"
            className="mb-4 overflow-hidden max-w-lg"
            style={{ perspective: "1000px" }}
          >
            <FlipFadeText
              words={["Frontend Developer", "UI Designer", "Creative Coder", "Problem Solver"]}
              interval={4500}
              letterDuration={0.8}
              staggerDelay={0.12}
              exitStaggerDelay={0.08}
              textClassName="font-extrabold leading-none text-white"
              style={{
