...
export const CreepyButton = ({
    ...
    return (
        <button
            className={cn(
                "relative min-w-[9em] rounded-full bg-black cursor-pointer outline-none select-none group tap-highlight-transparent shadow-[0_0_15px_rgba(212,175,55,0.3)] hover:shadow-[0_0_20px_rgba(212,175,55,0.6)] transition-shadow duration-300",
            ...
            <motion.span
                className={cn(
                    "absolute inset-0 block rounded-full bg-[#D4AF37] text-white font-semibold",
            ...
            <span
                className="block opacity-0 px-6 py-2.5 font-semibold min-w-[9em]">
                {children}
            </span>
        </button>
    );
